...
void Sandbox::Start(const char *title, int width, int height) {
...

  {
    ...
    Ref<VertexBuffer> position = VertexBuffer::Create(
        4, ShaderDataType::V2F, positionData, GL_STATIC_DRAW);
    Ref<VertexBuffer> uv =
        VertexBuffer::Create(4, ShaderDataType::V2F, uvData, GL_STATIC_DRAW);
    Ref<IndexBuffer> indexBuffer =
        IndexBuffer::Create(2, ShaderDataType::V3U, indices, GL_STATIC_DRAW);
  ...
  // glm::translate(glm::vec3(0.25f, 0.25f, 0.0f)) *
  // glm::rotate(glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
  glm::mat4 transformation = glm::mat4(1.0f);

  Ref<VertexBuffer> positionBuffer =
      VertexBuffer::Create(4, ShaderDataType::V2F, vertices, GL_STATIC_DRAW);
  Ref<VertexBuffer> colorBuffer =
      VertexBuffer::Create(4, ShaderDataType::V3F, colors, GL_STATIC_DRAW);
  Ref<VertexBuffer> uvBuffer =
      VertexBuffer::Create(4, ShaderDataType::V2F, uvs, GL_STATIC_DRAW);
